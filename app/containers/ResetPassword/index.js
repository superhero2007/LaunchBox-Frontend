...
import { resetPassword } from 'services/api/actions';
      ...
      <FullScreen>
        ...
        {this.state.step === 2 ? (
          ...
          <Content>
            ...
            <SubHeader>Please select a new password.</SubHeader>
            <Password
              label="New Password"
...
const mapDispatchToProps = dispatch => ({
  onResetPassword: value => dispatch(resetPassword.request(value)),
});
